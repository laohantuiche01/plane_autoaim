...
// std
#include <cmath>
#include <robot_utils/common.hpp>
#include <string>
#include <vector>
// third party 
...
// project
#include "robot_auto_aim/light_corner_corrector.hpp"
#include "robot_auto_aim/types.hpp"
#include "robot_auto_aim/number_classifier.hpp"
...
public:
  ...
  Detector(const int &bin_thres, const robot_utils::EnemyColor &color, const LightParams &l,
           const ArmorParams &a);
  ...
  // Parameters
  int binary_thres;
  robot_utils::EnemyColor detect_color;
  ...
  // Debug msgs
  cv::Mat binary_img;
  robot_interfaces::msg::DebugLights debug_lights;
  robot_interfaces::msg::DebugArmors debug_armors;
